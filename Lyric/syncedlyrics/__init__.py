...
def search(
    ...
    enhanced: bool = False,
    use_musixmatch_best: bool = False,
    search_without_artist: bool = False
) -> Optional[str]:
    """
    ...
    """
    _providers = [
        Musixmatch(lang=lang, enhanced=enhanced, use_musixmatch_best=use_musixmatch_best, search_without_artist=search_without_artist),
        Lrclib(),
        Deezer(),
        NetEase(),
        Genius(),
